...
public class RetakeConstraintType4Generator implements RetakeConstraintGenerator<RetakeConstraintType4> {
  ...
  public String generate(String contextClass, String invariantName, RetakeConstraintType4 rc4) {
    ...
    System.out.println("Check for existence: " + GeneratorUtils.buildExistsCheckCondition(rc4.targetAssoc, rc4.checkForExi, null));
    System.out.println("Check for existence2: " + GeneratorUtils.buildExistsCheckCondition(rc4.targetAssoc, rc4.checkForExi2, null));
    ...
    return """
        ...
        GeneratorUtils.buildExistsCheckCondition(rc4.targetAssoc, rc4.checkForExi, null),
        GeneratorUtils.buildExistsCheckCondition(rc4.targetAssoc, rc4.checkForExi2, null));
  }
}
