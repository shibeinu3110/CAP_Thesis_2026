package org.tzi.use.useCap.metamodel.status_constraint.type3;

import org.tzi.use.useCap.metamodel.eligibility_constraint.RootScope;
import org.tzi.use.useCap.metamodel.status_constraint.StatusConstraintGenerator;
...
public class StatusConstraintType3Generator implements StatusConstraintGenerator<StatusConstraintType3> {
  ...
  public String generate(String contextClass, String invariantName, StatusConstraintType3 sc3) {
    ...
    if (sc3.filters != null) {
      allowedCond = buildAllowedCondition(sc3.filters, RootScope.ALL, null, false);
    }
    String selectPart = "";
