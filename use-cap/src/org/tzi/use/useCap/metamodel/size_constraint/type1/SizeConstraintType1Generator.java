...
import org.tzi.use.useCap.metamodel.size_constraint.SizeConstraintGenerator;
...
import static org.tzi.use.useCap.util.GeneratorUtils.buildSizePathWithOperator;
...
public class SizeConstraintType1Generator implements SizeConstraintGenerator<SizeConstraintType1> {
  ...
  public String generate(String contextClass, String invariantName, SizeConstraintType1 sc1) {
    ...
    if (sc1.filters != null) {
      allowedCond = buildAllowedCondition(sc1.filters, RootScope.NONE, null, false);
    }
